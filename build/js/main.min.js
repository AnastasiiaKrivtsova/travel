...
var tabletPoster = './img/index/video-tablet.png';
var desktopPoster = './img/index/video-desktop.png';
var breakpoint = window.matchMedia('(max-width:1199px)');
var breakpointChecker = function breakpointChecker() {
  if (breakpoint.matches) {
    _video.video.setAttribute('poster', tabletPoster);
  } else {
...
},{"./video":7}],4:[function(require,module,exports){
"use strict";
...
var L = _interopRequireWildcard(require("../vendor/leaflet.js"));
...
var ZOOM_SIZE = 16;
var ICON_URL = './img/svg/map-pin.svg';
...
},{"../vendor/leaflet.js":18}],5:[function(require,module,exports){
"use strict";
...
var openMenu = function openMenu() {
  ...
  navLinks.forEach(function (link) {
    return link.classList.add('header__nav-link--is-open');
  });
...
var closeMenu = function closeMenu() {
  ...
  navLinks.forEach(function (link) {
    return link.classList.remove('header__nav-link--is-open');
  });
...
var initSwiper = function initSwiper() {
  ...
  heroSwiper.on('slideChange', function () {
    var previousSlide = heroSwiper.slides[heroSwiper.previousIndex];
    var videoOrAudio = previousSlide.querySelector('video, audio');
    if (videoOrAudio) {
      videoOrAudio.pause();
    }
  });
  heroSwiper.on('slideChangeTransitionEnd', function () {
    var currentSlide = heroSwiper.slides[heroSwiper.activeIndex];
    var videoOrAudio = currentSlide.querySelector('video, audio');
    if (videoOrAudio) {
      videoOrAudio.play();
    }
  });
...
},{"../vendor/swiper":19}],7:[function(require,module,exports){
"use strict";
...
var _initVideo = require("./blocks/init-video");
var _menu = require("./blocks/menu");
var _advantagesSwiper = require("./blocks/advantages-swiper");
var _map = require("./blocks/map");
var _initHero = require("./blocks/init-hero");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initHero.initHeroMargin)();
    (0, _pageSwiper.initSwiper)();
    (0, _initVideo.initVideo)();
    (0, _advantagesSwiper.initAdvantagesSlider)();
    (0, _map.setMap)();
...
},{"./blocks/advantages-swiper":1,"./blocks/init-hero":2,"./blocks/init-video":3,"./blocks/map":4,"./blocks/menu":5,"./blocks/page-swiper":6,"./modules/form-validate/form":10,"./utils/ios-vh-fix":17}],9:[function(require,module,exports){
"use strict";
